/*
------------------------------------------------------
Possibly The Best Discord Fun Bot(Ptbdfb)
------------------------------------------------------
Under the MIT Lisence.

 As well as proper acknowledgement while distributing the copy.
------------------------------------------------------
...
*/
/*
Ptbdfb uses its own database, using the npm package "level".
*/
